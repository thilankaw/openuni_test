...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card">
                <div class="card-header">Application for <?php echo e($job_det->name); ?></div>

                <div class="card-body">
                    <form id="create" onsubmit="return validateForm(this)" method="POST" action="<?php echo e(route('application.create')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control <?php if ($errors->has('name')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('name'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="surname" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
                                <input type="hidden" id="user_id" name="user_id" value="<?php echo e($user_id); ?>">
                                <input type="hidden" id="job_id" name="job_id" value="<?php echo e($job_id); ?>">
...
$message = $errors->first('name'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="first_name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
...
$message = $errors->first('name'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="national_id_no" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
...
$message = $errors->first('name'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="mobile_no" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" value="<?php echo e($user_email); ?>" required autocomplete="email">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="age" required autocomplete="new-password">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\open_uni\resources\views/application/create.blade.php ENDPATH**/ ?>